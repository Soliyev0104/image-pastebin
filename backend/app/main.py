...
from . import db, grpc_client, image_pb2
from .idempotency import idempotent
from .ws import broadcast_view, router as ws_router
...
app = FastAPI(
    ...
    description="Upload images, get short URLs, and watch live view counts.",
    version="1.0.0",
)
...
@app.post(
    ...
    response_description="The short code and derived image URLs",
)
@idempotent
async def upload(
    request: Request,
...
async def meta(code: str):
    ...
    return {
        ...
        "watermark_url": f"{PUBLIC}/images/{row['watermark_name']}",
...
<main>
    <img src="/images/{{ filename }}" alt="shared image" class="main-image">
